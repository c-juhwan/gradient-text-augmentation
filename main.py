    ...
    if args.job == None:
        ...
        if args.task == 'augmentation':
            if args.job == 'preprocessing':
                from task.augmentation.preprocessing import preprocessing as job
            elif args.job in ['training', 'resume_training']:
                from task.augmentation.train import training as job
            elif args.job == 'testing':
                from task.augmentation.test import testing as job
            elif args.job == 'inference':
                from task.augmentation.inference import inference as job
            else:
